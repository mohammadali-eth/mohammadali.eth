  ...
  if (!project) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <p className="text-white/40 font-mono uppercase tracking-[0.4em]">
            ...
            <div className="lg:col-span-8">
              ...
              {project.skills && (
                <div className="space-y-6">
                  <h3 className="text-white/40 font-mono text-xs uppercase tracking-[0.3em]">
                ...
                <div className="space-y-4">
                  {project.live && (
                    <a
                      ...
                      className="block w-full p-6 border border-white bg-white text-black text-center text-xs font-black uppercase tracking-[0.2em] hover:bg-transparent hover:text-white transition-all"
                    >
                      View Live Site
                    </a>
                  )}
                  {project.code && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="block w-full p-6 border border-white/20 text-center text-xs font-black uppercase tracking-[0.2em] hover:border-white transition-all"
                    >
                      Source Code
                    </a>
                  )}
