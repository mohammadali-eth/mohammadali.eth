...
import { ArrowDown, Code, Layout, Server, Database, Globe, ArrowRight } from "lucide-react";
      ...
      <div className="pt-16 md:pt-24 space-y-12 md:space-y-20">
        ...
        <section className="space-y-12 md:space-y-16">
          ...
          >
            <h1 className="text-[12vw] sm:text-[8vw] md:text-[6vw] lg:text-[6.5vw] font-black tracking-tighter leading-[0.85] uppercase -ml-1 border-b border-white/5 pb-8 md:pb-12 transition-all">
              {firstName} <br />
              <span className="text-white/20 hover:text-white transition-colors duration-1000 cursor-default">{lastName}</span>
            </h1>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-12 gap-10 md:gap-12">
            <div className="lg:col-span-8 space-y-10 md:space-y-12">
              <p className="text-xl sm:text-2xl md:text-3xl font-light text-gray-400 leading-tight max-w-2xl uppercase tracking-wider">
                I specialize in <span className="text-white font-black">Scalable Web Infrastructures</span> and high-impact digital experiences. Delivering precision and performance at scale.
              </p>
        ...
        <section className="grid grid-cols-2 lg:grid-cols-4 gap-px bg-white/10 border border-white/10">
          <div className="p-8 md:p-12 bg-black space-y-6 group hover:bg-white/[0.02] transition-colors">
            <Layout size={32} className="text-white/20 group-hover:text-white transition-colors" />
            <div className="space-y-2">
              <h3 className="font-bold uppercase tracking-widest text-xs">Frameworks</h3>
              <p className="text-[10px] text-gray-600 font-mono leading-relaxed uppercase">REACT, NEXT.JS, TAILWIND, FRAMER</p>
            </div>
          </div>
          <div className="p-8 md:p-12 bg-black space-y-6 group hover:bg-white/[0.02] transition-colors">
            <Server size={32} className="text-white/20 group-hover:text-white transition-colors" />
            <div className="space-y-2">
              <h3 className="font-bold uppercase tracking-widest text-xs">Backend</h3>
              <p className="text-[10px] text-gray-600 font-mono leading-relaxed uppercase">NODE, NESTJS, RAILS, EXPRESS</p>
            </div>
          </div>
          <div className="p-8 md:p-12 bg-black space-y-6 group hover:bg-white/[0.02] transition-colors">
            <Database size={32} className="text-white/20 group-hover:text-white transition-colors" />
            <div className="space-y-2">
              <h3 className="font-bold uppercase tracking-widest text-xs">Data</h3>
              <p className="text-[10px] text-gray-600 font-mono leading-relaxed uppercase">POSTGRES, MONGO, REDIS, MYSQL</p>
            </div>
          </div>
          <div className="p-8 md:p-12 bg-black space-y-6 group hover:bg-white/[0.02] transition-colors">
            <Globe size={32} className="text-white/20 group-hover:text-white transition-colors" />
            <div className="space-y-2">
              <h3 className="font-bold uppercase tracking-widest text-xs">Deployment</h3>
              <p className="text-[10px] text-gray-600 font-mono leading-relaxed uppercase">AWS, DOCKER, VERCEL, ACTIONS</p>
            </div>
          </div>
        </section>
      </div>
